...
RUN ./rustup-init.sh -y -c rustfmt --default-toolchain nightly-2023-09-07
ENV PATH="$PATH:/root/.cargo/bin"
RUN rustup target add --toolchain nightly-2023-09-07 x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu
