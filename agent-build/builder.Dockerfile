...
RUN ./rustup-init.sh -y -c rustfmt --default-toolchain nightly-2023-01-31
ENV PATH="$PATH:/root/.cargo/bin"
RUN /root/.cargo/bin/rustup target add --toolchain nightly-2023-01-31 x86_64-unknown-linux-gnu aarch64-unknown-linux-gnu armv7-unknown-linux-gnueabihf
